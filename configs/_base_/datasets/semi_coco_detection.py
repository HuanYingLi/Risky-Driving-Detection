...
#unlabel_data_root = '/NAS/HUST_WHU/lihuanying/data/statefarm_coco/'
#label_data_root = '/NAS/HUST_WHU/lihuanying/data/statefarm_coco/'
unlabel_data_root = '/NAS/HUST_WHU/lihuanying/detection/mmdetection-3.x/data/coco/'
label_data_root = '/NAS/HUST_WHU/lihuanying/detection/mmdetection-3.x/data/coco/'
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=label_data_root + 'annotations/instances_val2017.json',
    metric='bbox',
    format_only=False)
